...
export const dataTablePreviewComponentDefinition = {
    ...
    events: ["open"],
    description: "Read-only, compact preview of a data source — the smaller half of the preview/detail " +
...
export const dataTableDetailComponentDefinition = {
    ...
    description: "Full interactive grid over a data source — the larger half of the preview/detail " +
