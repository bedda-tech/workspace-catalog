...
export const tableColumnSchema = z.object({
    ...
    type: z
        ...
        .describe("Which editor the cell renders and how its value is displayed: select/multiSelect show " +
    ...
    options: z
        ...
        .nullable()
        .describe("Legal values for select/multiSelect columns, e.g. [{\"value\":\"todo\",\"label\":\"To Do\",\"color\":\"blue\"}]. " +
